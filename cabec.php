		...
		<header>
			<nav class="navbar navbar-expand-lg navbar-dark cor_barra">
			  	<div class="container-fluid">
					<a class="navbar-brand" href="./"><button class="button" data-text="Awesome">
    <span class="actual-text">&nbsp;DropWave&nbsp;</span>
    <span aria-hidden="true" class="hover-text">&nbsp;DropWave&nbsp;</span>
</button></a>
